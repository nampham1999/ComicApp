...
const Categories = ({ navigation }: any) => {
    ...
    const renderItem = ({
        ...
        return <TouchableOpacity
            ...
            activeOpacity={0.9} style={styles.af8a17120348411ec92980fa8d3b47c02}>
            <TText style={styles.af8a19830348411ec92980fa8d3b47c02}>{item?.name?.trim()}</TText>

            <TText style={styles.af8a19831348411ec92980fa8d3b47c02} numberOfLines={2} ellipsizeMode='tail'>{item?.info?.trim()}</TText>
        </TouchableOpacity>
    }
    ...
    return <SafeAreaView style={styles.container}>
        ...
        <FlatList showsVerticalScrollIndicator={false} columnWrapperStyle={{
            alignItems: 'center',
            justifyContent: 'space-evenly'
        }} numColumns={2} renderItem={renderItem} keyExtractor={(item: any) => item.id + ''} data={categories} ListEmptyComponent={loading ? <ActivityIndicator style={styles.af8a1bf40348411ec92980fa8d3b47c02} color={Colors.Primary} /> : null} />
