...
const Search = () => {
    ...
    const renderItem = ({
        item,
        index
    }: any) => <PostItemVertical item={item} />;

    if (!isConnect) return <Nointernet />

    return <SafeAreaView style={styles.a5d77271034a911ec92980fa8d3b47c02}>
        <View style={styles.a5d77271134a911ec92980fa8d3b47c02}>
            <View style={styles.a5d774e2034a911ec92980fa8d3b47c02}>
                ...
                <TextInput ref={refSearch} returnKeyType='search' returnKeyLabel='Tìm kiếm' onSubmitEditing={onSearch} value={keyword} onChangeText={setKeyword} autoFocus placeholder='Nhập từ khóa tìm kiếm' clearTextOnFocus placeholderTextColor='gray' style={styles.a5d774e2134a911ec92980fa8d3b47c02} />
                {keyword.length ? <TouchableOpacity onPress={() => {
                    setKeyword('')
                    setData([])
                }}>
        ...
        <FlatList numColumns={Layout.isPad ? 2 : 1} renderItem={renderItem} data={data} keyExtractor={(item, index) => index + ''} ListEmptyComponent={loading ? <ActivityIndicator style={styles.a5d77753034a911ec92980fa8d3b47c02} color={Colors.Primary} /> : keyword ? <TText style={styles.a620110a034d811ec820a610690ddbe1e}>Không có kết quả nào phù hợp</TText> : null} onEndReachedThreshold={0.3} onEndReached={loadMore} />
    </SafeAreaView>;
};
