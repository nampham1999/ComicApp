...
export class HomeScreen extends Component<Props, State> {
    ...
    componentDidMount() {
        ...
        unsubscribe = NetInfo.addEventListener(state => {
            if (!state.isConnected) SimpleToast.show("Bạn đang ngoại tuyến , bạn chỉ có thể đọc truyện đã tải trong tủ truyện")
            this.props.dispatch({
                type: 'SET_NETWORK',
    ...
    render() {
        if (!this.props.isConnect && !this.props.banner.length && !this.props.newpost.length && !this.props.compeletePost.length && !this.props.pendingPost.length) return <Nointernet />
        return (
            <View style={styles.container}>
                <StatusBar translucent backgroundColor='transparent' barStyle='dark-content' />

                <ScrollView contentContainerStyle={{ paddingBottom: 30 }} bounces={false} showsVerticalScrollIndicator={false}>
                    ...
                    <BannerAd
                        ...
                        unitId={ads.idBanner} />
                    <CardPostScroll data={this.props.newpost}
                    ...
                    <CardPostScroll data={this.props.compeletePost}
                    ...
                    <CardPostScroll data={this.props.pendingPost}
