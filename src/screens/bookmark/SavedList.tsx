...
const SavedList = () => {
    ...
    return <View style={styles.a3a737040349811ec92980fa8d3b47c02}>
        <FlatList
            ListHeaderComponent={<BannerAd
                ...
                unitId={ads.idBanner} />}
            numColumns={Layout.isPad ? 2 : 1} renderItem={renderItem} data={data} keyExtractor={(item, index) => index + ''} ListEmptyComponent={<TText style={styles.a3a739750349811ec92980fa8d3b47c02}>Bạn chưa thêm truyện nào </TText>} />
    </View>;
};
