...
import ReadPost from '../screens/read/ReadPost';
...
const DemoScreen = () => <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
    <ActivityIndicator color={Colors.Primary} />
    <TText style={{
        color: Colors.Primary,
        marginTop: 10
    }}>Đang tải dữ liệu...</TText>
        ...
        <NavigationContainer>
            ...
            >
                ...
                <StackNavigation.Screen
                    ...
                    name="DetailPost" component={DetailPost} />
                <StackNavigation.Screen
                    options={{
                        headerShown: false,
                    }}
                    name="ReadPost" component={ReadPost} />
                ...
                <StackNavigation.Screen
                    ...
                    name="ListPost" component={ListPost} />
            </StackNavigation.Navigator>
        </NavigationContainer>
    );
}
