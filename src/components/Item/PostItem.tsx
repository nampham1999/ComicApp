...
const PostItem = ({ item, index, width }: any) => {
    ...
    return (
        <TouchableOpacity
            ...
            style={[styles.wrapItem, { width: width || Layout.isPad ? Layout.window.width / 3.5 : Layout.window.width / 2.5 }]}>
            <FastImage
            ...
            <View style={styles.wrapTag}>
                {item.array_category?.slice(0, 3).map((i: any, idx: number) => <View key={idx} style={styles.wrapTxtCate}>
