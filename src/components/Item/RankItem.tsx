...
const renderRank = (index: number) => {
    switch (index + 1) {
        case 1:
            return <FastImage style={styles.a2cef328039ff11ec8ae839f315486395} source={require('../../assets/images/rank1.png')} />;

        case 2:
            return <FastImage style={styles.a2cef599039ff11ec8ae839f315486395} source={require('../../assets/images/rank2.png')} />;

        case 3:
            return <FastImage style={styles.a2cef599139ff11ec8ae839f315486395} source={require('../../assets/images/rank3.png')} />;
...
const RankItem = ({
    ...
    return <TouchableOpacity onPress={() => navigation.navigate('DetailPost', {
        item
        ...
        <View style={styles.a2cefa7b039ff11ec8ae839f315486395}>
            <TText numberOfLines={2} ellipsizeMode="tail" style={styles.a2cefa7b139ff11ec8ae839f315486395}>
                {item.name?.trim()}
            </TText>
            ...
            <View style={styles.wrapInfo}>
                <View style={styles.infoItem}>
                    ...
                    <TText style={[styles.nomal, {
                        ...
                        marginLeft: 3,
                        marginTop: 0
                    }]}>{formatMoney(item.total_view)}</TText>
                </View>
            </View>
